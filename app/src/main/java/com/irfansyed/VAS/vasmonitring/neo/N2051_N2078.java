...
public class N2051_N2078 extends AppCompatActivity {
    ...
    private void GetDataFromDB() {
        ...
        String n2006 = db.getSpecificData(data.neo.N2001_N2011.TABLE_NAME, bi.edStudyId.getText().toString(), sub_N2001_N2011.N2006);
        if (n2006.equals("99") || n2006.equals("1") || n2006.equals("2")) {
            flag_n2006 = false;
        }

        String n2008 = db.getSpecificData(data.neo.N2001_N2011.TABLE_NAME, bi.edStudyId.getText().toString(), sub_N2001_N2011.N2008);
        if (n2008.equals("9")) {
            flag_n2008 = false;
        }
