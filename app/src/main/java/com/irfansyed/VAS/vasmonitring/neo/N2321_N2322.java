...
import com.irfansyed.vas.vasmonitring.general.InterviewEnd;
...
public class N2321_N2322 extends AppCompatActivity {
    ...
    private void GetDataFromDB() {
        ...
        String n2016 = db.getSpecificData(data.neo.N2012_N2016.TABLE_NAME, bi.edStudyId.getText().toString(), N2012_N2016.sub_N2012_N2016.N2016);
        if (n2016 != null) {
