package com.irfansyed.vas.vasmonitring.rep;
        ...
        if (v.getId() == R.id.btn_next) {
            ...
            if (res.getCount() > 0) {
                ...
                if (Integer.valueOf(res.getString(res.getColumnIndex("Q1609"))).equals(1)) {
                    ...
                    Intent c = new Intent(this, com.irfansyed.vas.vasmonitring.neo.N2001_N2011.class);
                    c.putExtra("study_id", study_id);
                    startActivity(c);

                } else if (Integer.valueOf(res.getString(res.getColumnIndex("Q1609"))).equals(2)) {

                    Intent c = new Intent(this, com.irfansyed.vas.vasmonitring.child.C3001_C3011.class);
                    c.putExtra("study_id", study_id);
                    startActivity(c);
                    ...
                    Intent c = new Intent(this, com.irfansyed.vas.vasmonitring.child.C3012_C3022.class);
                    c.putExtra("study_id", study_id);
                    startActivity(c);

                } else if (Integer.valueOf(res.getString(res.getColumnIndex("Q1609"))).equals(5)) {

                    Intent c = new Intent(this, com.irfansyed.vas.vasmonitring.adult.A4001_A4014.class);
                    c.putExtra("study_id", study_id);
                    startActivity(c);
                }
            }
