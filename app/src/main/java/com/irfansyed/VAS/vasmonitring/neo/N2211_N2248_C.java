...
import static com.irfansyed.vas.vasmonitring.neo.N2211_N2248_A.n2211A_ID;
...
//        Inst_1
        ...
        for (N2211_N2248_B col_data : col_n2211) {
            if (col_data.getN22132A().equals("1")) {
                ...
                String n2098 = db.getSpecificData(data.neo.N2080_N2107.TABLE_NAME, bi.edStudyId.getText().toString(), Global.N.N2080_N2107.sub_N2080_N2107.N2098);
...
//        Inst_3
            String n2212 = db.getSpecificData(data.neo.N2211_N2248_A_C.TABLE_NAME, bi.edStudyId.getText().toString(), N2211_N2248_A_C.sub_N2211_N2248_A_C.N2212);
            if (n2212 != null) {
