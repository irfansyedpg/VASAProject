...
public class N2192_N2202 extends AppCompatActivity {
    ...
    public boolean SaveData() {
        ...
        n2192.setN2192(bi.rbN21921.isChecked() ? "1" : bi.rbN21922.isChecked() ? "2" : bi.rbN2192DK.isChecked() ? "9" : "0");
        n2192.setN2193(bi.rbN21931.isChecked() ? "1" : bi.rbN21932.isChecked() ? "2" : bi.rbN2193DK.isChecked() ? "9" : "0");
        n2192.setN2194_1(bi.edN21941.getText().toString());
        n2192.setN2194_2(bi.edN21942.getText().toString());
        n2192.setN2195(bi.rbN21951.isChecked() ? "1" : bi.rbN21952.isChecked() ? "2" : bi.rbN2195DK.isChecked() ? "9" : "0");
        n2192.setN2196(bi.rbN21961.isChecked() ? "1" : bi.rbN21962.isChecked() ? "2" : bi.rbN2196DK.isChecked() ? "9" : "0");
        n2192.setN2197(bi.rbN21971.isChecked() ? "1" : bi.rbN21972.isChecked() ? "2" : bi.rbN2197DK.isChecked() ? "9" : "0");

        n2192.setN2198_1(bi.cbN21981.isChecked() ? "1" : "0");
        n2192.setN2198_1_T(bi.edN21981T.getText().toString());
        n2192.setN2198_1_FV(bi.edN21981FV.getText().toString());
        n2192.setN2198_2(bi.cbN21982.isChecked() ? "2" : "0");
        n2192.setN2198_2_T(bi.edN21982T.getText().toString());
        n2192.setN2198_2_FV(bi.edN21982FV.getText().toString());
        n2192.setN2198_3(bi.cbN21983.isChecked() ? "3" : "0");
        n2192.setN2198_DK(bi.cbN2198DK.isChecked() ? "9" : "0");

        n2192.setN2199(bi.rbN21991.isChecked() ? "1" : bi.rbN21992.isChecked() ? "2" : bi.rbN2199DK.isChecked() ? "9" : "0");
        n2192.setN2200(bi.rbN22001.isChecked() ? "1" : bi.rbN22002.isChecked() ? "2" : bi.rbN2200DK.isChecked() ? "9" : "0");
        n2192.setN2201(bi.rbN22011.isChecked() ? "1" : bi.rbN22012.isChecked() ? "2" : bi.rbN2201DK.isChecked() ? "9" : "0");

        n2192.setN2202_1(bi.cbN22021.isChecked() ? "1" : "0");
        n2192.setN2202_1_T(bi.edN22021T.getText().toString());
        n2192.setN2202_1_FV(bi.edN22021FV.getText().toString());
        n2192.setN2202_2(bi.cbN22022.isChecked() ? "2" : "0");
        n2192.setN2202_2_T(bi.edN22022T.getText().toString());
        n2192.setN2202_2_FV(bi.edN22022FV.getText().toString());
        n2192.setN2202_3(bi.cbN22023.isChecked() ? "3" : "0");
