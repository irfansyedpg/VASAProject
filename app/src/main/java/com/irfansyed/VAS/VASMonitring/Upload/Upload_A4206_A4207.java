 ...
 */
public class Upload_A4206_A4207 extends AsyncTask {
    ...
    public Upload_A4206_A4207(Context context) {
    ...
    protected void onPostExecute(Object o) {
        ...
        try {
          ...
          if(mUserMsg != null)
            ...
            Toast.makeText(mContext, "A4206_A4207 section Uploaded", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(mContext,"Uploading failed at request A4206_A4207 section", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
            return;
        }
        finally {
